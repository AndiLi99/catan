...
void TextDisplay::printCoordBoard(){
	...
	cout<<"        | |+0,+2| |+1,+1| |+2,+0| |\n";
	cout<<"        ( )     ( )     ( )     ( )                     *: place holder\n";
	cout<<"      / / \\ \\ / / \\ \\ / / \\ \\ / / \\ \\                   *-* place holder for resource & number Ex. B04 (Brick04)\n";
	cout<<"    ( )     ( )     ( )     ( )     ( )                 (*) place holder for settlement\n";
	cout<<"    | |-1,+2| |+0,+1| |+1,+0| |+2,-1| |                 [*] place holder for city\n";
	cout<<"    ( )     ( )     ( )     ( )     ( )                 ( ) empty spot for settlement\n";
	cout<<"  / / \\ \\ / / \\ \\ / / \\ \\ / / \\ \\ / / \\ \\\n";
	cout<<"( )     ( )     ( )     ( )     ( )     ( )             /*/\n";
	cout<<"| |-2,+2| |-1,+1| |+0,+0| |+1,-1| |+2,-2| |             |*| Place holder for roads\n";
	cout<<"( )     ( )     ( )     ( )     ( )     ( )             \\*\\\n";
	cout<<"  \\ \\ / / \\ \\ / / \\ \\ / / \\ \\ / / \\ \\ / /\n";
	cout<<"    ( )     ( )     ( )     ( )     ( )                 / /\n";
	cout<<"    | |-2,+1| |-1,+0| |+0,-1| |+1,-2| |                 | |  Empty roads\n";
	cout<<"    ( )     ( )     ( )     ( )     ( )                 \\ \\\n";
	cout<<"      \\ \\ / / \\ \\ / / \\ \\ / / \\ \\ / /\n";
	cout<<"        ( )     ( )     ( )     ( )                     1, 2, 3, 4 : Player tokens\n";
	cout<<"        | |-2,+0| |-1,-1| |+0,-2| |                     -------------------------\n";
	cout<<"        ( )     ( )     ( )     ( )\n";
	cout<<"          \\ \\ / / \\ \\ / / \\ \\ / /\n";
	cout<<"            ( )     ( )     ( )\n";
...
void TextDisplay::printBoard(){
	...
	cout << "          /"<<roads[0]<<"/ \\"<<roads[1]<<"\\ /"<<roads[2]<<"/ \\"<<roads[3]<<"\\ /"<<roads[4]<<"/ \\"<<roads[5]<<"\\"<<"\n";

	cout << "        "<<vertices[3]<<"     "<<vertices[4]<<"     "<<vertices[5]<<"     "<<vertices[6]<<"\n";

	cout << "        |"<<roads[6]<<"| "<<Letter[0]<<setw(2)<<boardNum[0]<<" |"<<roads[7]<<"| "
							<<Letter[1]<<setw(2)<<boardNum[1]<<" |"<<roads[8]<<"| "
								<<Letter[2]<<setw(2)<<boardNum[2]<<" |"<<roads[9]<<"|"<<"\n";

	cout << "        "<<vertices[7]<<"     "<<vertices[8]<<"     "<<vertices[9]<<"     "<<vertices[10]<<"\n";

	cout << "      /"<<roads[10]<<"/ \\"<<roads[11]<<"\\ /"<<roads[12]<<"/ \\"<<roads[13]<<"\\ /"<<roads[14]<<"/ \\"<<roads[15]<<"\\ /"<<roads[16]<<"/ \\"<<roads[17]<<"\\"<<"\n";

	cout << "    "<<vertices[11]<<"     "<<vertices[12]<<"     "<<vertices[13]<<"     "<<vertices[14]<<"     "<<vertices[15]<<"\n";

	cout << "    |"<<roads[18]<<"| "<<Letter[3]<<setw(2)<<boardNum[3]<<" |"<<roads[19]<<"| "
						<<Letter[4]<<setw(2)<<boardNum[4]<<" |"<<roads[20]<<"| "
							<<Letter[5]<<setw(2)<<boardNum[5]<<" |"<<roads[21]<<"| "
								<<Letter[6]<<setw(2)<<boardNum[6]<<" |"<<roads[22]<<"|"<<"\n";

	cout << "    "<<vertices[16]<<"     "<<vertices[17]<<"     "<<vertices[18]<<"     "<<vertices[19]<<"     "<<vertices[20]<<"\n";

	cout << "  /"<<roads[23]<<"/ \\"<<roads[24]<<"\\ /"<<roads[25]<<"/ \\"<<roads[26]<<"\\ /"<<roads[27]<<"/ \\"<<roads[28]<<"\\ /"<<roads[29]<<"/ \\"<<roads[30]<<"\\ /"<<roads[31]<<"/ \\"<<roads[32]<<"\\"<<"\n";

	cout << ""<<vertices[21]<<"     "<<vertices[22]<<"     "<<vertices[23]<<"     "<<vertices[24]<<"     "<<vertices[25]<<"     "<<vertices[26]<<"\n";
					...
					<<Letter[8]<<setw(2)<<boardNum[8]<<" |"<<roads[35]<<"| "
						<<Letter[9]<<setw(2)<<boardNum[9]<<" |"<<roads[36]<<"| "
							<<Letter[10]<<setw(2)<<boardNum[10]<<" |"<<roads[37]<<"| "<<
								Letter[11]<<setw(2)<<boardNum[11]<<" |"<<roads[38]<<"|"<<"\n";

	cout << ""<<vertices[27]<<"     "<<vertices[28]<<"     "<<vertices[29]<<"     "<<vertices[30]<<"     "<<vertices[31]<<"     "<<vertices[32]<<"\n";

	cout << "  \\"<<roads[39]<<"\\ /"<<roads[40]<<"/ \\"<<roads[41]<<"\\ /"<<roads[42]<<"/ \\"<<roads[43]<<"\\ /"<<roads[44]<<"/ \\"<<roads[45]<<"\\ /"<<roads[46]<<"/ \\"<<roads[47]<<"\\ /"<<roads[48]<<"/"<<"\n";

	cout << "    "<<vertices[33]<<"     "<<vertices[34]<<"     "<<vertices[35]<<"     "<<vertices[36]<<"     "<<vertices[37]<<"\n";
	...
	cout << "    |"<<roads[49]<<"| "<<Letter[12]<<setw(2)<<boardNum[12]<<" |"<<roads[50]<<"| "
						<<Letter[13]<<setw(2)<<boardNum[13]<<" |"<<roads[51]<<"| "
							<<Letter[14]<<setw(2)<<boardNum[14]<<" |"<<roads[52]<<"| "
								<<Letter[15]<<setw(2)<<boardNum[15]<<" |"<<roads[53]<<"|"<<"\n";

	cout << "    "<<vertices[38]<<"     "<<vertices[39]<<"     "<<vertices[40]<<"     "<<vertices[41]<<"     "<<vertices[42]<<"\n";

	cout << "      \\"<<roads[54]<<"\\ /"<<roads[55]<<"/ \\"<<roads[56]<<"\\ /"<<roads[57]<<"/ \\"<<roads[58]<<"\\ /"<<roads[59]<<"/ \\"<<roads[60]<<"\\ /"<<roads[61]<<"/"<<"\n";

	cout << "        "<<vertices[43]<<"     "<<vertices[44]<<"     "<<vertices[45]<<"     "<<vertices[46]<<"\n";

	cout << "        |"<<roads[62]<<"| "<<Letter[16]<<setw(2)<<boardNum[16]<<" |"<<roads[63]<<"| "
							<<Letter[17]<<setw(2)<<boardNum[17]<<" |"<<roads[64]<<"| "
								<<Letter[18]<<setw(2)<<boardNum[18]<<" |"<<roads[65]<<"|"<<"\n";

	cout << "        "<<vertices[47]<<"     "<<vertices[48]<<"     "<<vertices[49]<<"     "<<vertices[50]<<"\n";

	cout << "          \\"<<roads[66]<<"\\ /"<<roads[67]<<"/ \\"<<roads[68]<<"\\ /"<<roads[69]<<"/ \\"<<roads[70]<<"\\ /"<<roads[71]<<"/"<<"\n";

	cout << "            "<<vertices[51]<<"     "<<vertices[52]<<"     "<<vertices[53]<<"\n";
	cout<< "=========================================="<<endl;
